<?php
    try {
        ...
        $selectQuery = $conn->prepare("SELECT pay_method, history, tasks_type, DATE_FORMAT(date, '%d.%m.%Y') as formatted_date FROM tasks WHERE ID = ?");
